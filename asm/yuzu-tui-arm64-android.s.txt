...
.ascii "  \xe2\x94\x82   API Monitor - Bionic/Termux             \xe2\x94\x82\n"
.ascii "  \xe2\x94\x82                                         \xe2\x94\x82\n"
...
// Bionic usa offset 32 para ai_addr (glibc usa 24)
.equ AI_FAMILY,   4
.equ AI_SOCKTYPE, 8
.equ AI_ADDR,     32
.equ AI_ADDRLEN,  16

// 2000000 = 0x1E8480 — no cabe en MOV simple ARM64
// Se carga con movz+movk en sleep_loop
.equ SLEEP_LO,    0x8480   // 2000000 & 0xFFFF
.equ SLEEP_HI,    0x001E   // 2000000 >> 16
...
sleep_loop:
    // FIX: 2000000 no cabe en MOV — usar movz+movk
    movz x0, #SLEEP_LO
    movk x0, #SLEEP_HI, lsl #16
    bl usleep
    b monitor_loop
...
.req_done:
    ldp x19, x20, [sp, #16]
    ldp x21, x22, [sp, #32]
    // FIX: epilogo correcto — post-index, no pre-index
    ldp x29, x30, [sp], #48
    ret
